...
//     --location japaneast \
//     --template-file eo-re-d1-az-child-mgmt-grp.bicep \
...
//
// POST-DEPLOYMENT:
// 1. Deploy eo-re-d1-az-child-mgmt-grp-policies.bicep for policy assignments
...
param EO_AZ_CHILD_MANAGEMENT_GROUP_ID string = 'eo-re-d1-az-child-mgmt-grp'
...
param EO_AZ_CHILD_MANAGEMENT_GROUP_DISPLAY_NAME string = 'Edge Optimizer RE D1 Management Group'
