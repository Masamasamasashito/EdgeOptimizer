 ...
 * TypeScript port of RequestEngine/Web/funcfiles/common/request_engine_core.py
 *
...
// Matches RequestEngine/Web/funcfiles/common/request_engine_core.py _CDN_DETECTION_CONFIG
...
// ======================================================================
// Matches RequestEngine/Web/funcfiles/common/request_engine_core.py _EXTENSION_REGISTRY
//
// 拡張機能の追加方法:
// 1. RequestEngine/Web/funcfiles/common/ts/extensions/_ext_<name>.ts を作成
// 2. ファイル内で registerExtension() を呼び出す
// 3. deploy-ts-to-cf-worker-web.yml の _02_extensions.ts 生成ステップに import を追加
 ...
 *
 * Matches RequestEngine/Web/funcfiles/common/request_engine_core.py register_extension()
 *
 ...
 *
 * Matches RequestEngine/Web/funcfiles/common/request_engine_core.py _calc_token()
 *
 ...
 *
 * Matches RequestEngine/Web/funcfiles/common/request_engine_core.py _get_url_extension()
 *
 * @param url - Target URL
 ...
 *
 * Matches RequestEngine/Web/funcfiles/common/request_engine_core.py _determine_resource_type()
 *
 * Asset extensions:
 ...
 *
 * Matches RequestEngine/Web/funcfiles/common/request_engine_core.py _detect_cdn()
 *
 ...
 *
 * Output key order matches RequestEngine/Web/funcfiles/common/request_engine_core.py _build_flat_result()
 *
...
export function buildFlatResult(params: ExecutionResultParams): JsonRecord {
  ...
  // ==================================================================
  // 6. Measurements
  //    Matches RequestEngine/Web/funcfiles/common/request_engine_core.py _build_flat_result()
  // ==================================================================
  ...
  //    Matches RequestEngine/Web/funcfiles/common/request_engine_core.py build_extension_output()
  // ==================================================================
