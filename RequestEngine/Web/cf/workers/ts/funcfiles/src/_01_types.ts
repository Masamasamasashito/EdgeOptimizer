...
// Matches RequestEngine/Web/funcfiles/common/py/request_engine_core.py _determine_resource_type() output
...
// Matches RequestEngine/Web/funcfiles/common/py/request_engine_core.py _build_flat_result() signature
