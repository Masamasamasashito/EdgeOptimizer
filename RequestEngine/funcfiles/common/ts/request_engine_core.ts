 ...
 * TypeScript port of RequestEngine/funcfiles/common/request_engine_core.py
 *
...
// Matches RequestEngine/funcfiles/common/request_engine_core.py _CDN_DETECTION_CONFIG
...
// ======================================================================
// Matches RequestEngine/funcfiles/common/request_engine_core.py _EXTENSION_REGISTRY
//
// 拡張機能の追加方法:
 ...
 *
 * Matches RequestEngine/funcfiles/common/request_engine_core.py register_extension()
 *
 ...
 *
 * Matches RequestEngine/funcfiles/common/request_engine_core.py _calc_token()
 *
 ...
 *
 * Matches RequestEngine/funcfiles/common/request_engine_core.py _get_url_extension()
 *
 * @param url - Target URL
 ...
 *
 * Matches RequestEngine/funcfiles/common/request_engine_core.py _determine_resource_type()
 *
 * Asset extensions:
 ...
 *
 * Matches RequestEngine/funcfiles/common/request_engine_core.py _detect_cdn()
 *
 ...
 *
 * Output key order matches RequestEngine/funcfiles/common/request_engine_core.py _build_flat_result()
 *
...
export function buildFlatResult(params: ExecutionResultParams): JsonRecord {
  ...
  //    Matches RequestEngine/funcfiles/common/request_engine_core.py build_extension_output()
  // ==================================================================
