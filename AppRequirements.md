...
File Path References: コード内のコメント、ドキュメント、またはチャット内でファイルを参照する際は、必ずリポジトリルートからのフルパス（例: RequestEngine/Web/aws/lambda/py/funcfiles/_01_imports.py）で記載すること。ファイル名単体の使用は禁止。
